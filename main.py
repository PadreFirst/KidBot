...
# Быстрые действия под списком предложений — идей, игр, занятий, чего угодно.
#
...
# в истории переписки: «ещё», «а поподробнее вот это» и «давай совсем другое».
QUICK_ACTIONS: dict[str, tuple[str, str]] = {
    "more": (
        "✨ Ещё",
        "Предложи ещё 5 штук, совершенно новых. Ничего из того, что уже было.",
    ),
    "detail": (
        "🔍 Про первое подробнее",
        "Возьми первый пункт из прошлого сообщения и расскажи подробно: "
        "что делать по шагам, что понадобится и в чём главная хитрость. "
        "Коротко и по делу.",
    ),
    "other": (
        "🎲 Совсем другое",
        "Предложи 5 вариантов совсем другого типа — другая тема, другой "
        "формат, другое настроение. Не похоже на прошлые.",
    ),
}
...
async def cmd_start(message: Message):
    ...
    await message.answer(
        ...
        "Я тут, чтобы болтать с тобой обо всём. Можно:\n"
        "• спросить про что угодно на свете\n"
        "• рассказать, как прошёл день\n"
        "• поиграть в загадки или придумать что-нибудь вместе\n"
        "• попросить сказку, шутку или картинку\n"
        "• позвать на помощь с уроками\n\n"
        "Пиши, говори голосом или шли фотку — я всё вижу и слышу 🎤",
